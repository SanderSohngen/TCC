...
def lambda_handler(event, context):
    ...
    professionals_info = fetch_professionals_info(profession)
...
def fetch_professionals_info(profession):
    url = os.environ.get("PROFESSIONALS_URL")
    response = requests.get(url, params={"profession": profession})
